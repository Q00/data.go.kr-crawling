...
def getLink():
    baseUrl = 'http://apis.data.go.kr/B551182/nonPaymentDamtInfoService/'
    #오퍼레이션명
    urlList = 'getNonPaymentItemCodeList', 'getNonPaymentItemHospList',#'',  '', '', '', '', '', '', '',
    ...
    for addUrl in urlList:
        ...
        params = {'servicekey': main.key, 'numOfRows': 5000}
        print(addUrl)
